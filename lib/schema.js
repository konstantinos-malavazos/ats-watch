...
// "home based" earns its place here on evidence, not guesswork: a scan of all
// 3342 postings across the 25 configured boards (2026-08-24) found it was the
// ONLY remote-sounding phrasing the pattern missed, on 271 rows. Canonical
// writes every remote role as "Home based - EMEA" / "Home based - Worldwide"
// and never uses the word "remote", so 297 of its 303 fully-remote postings
// were reaching the ranker looking on-site.
//
// Nothing else was added. That same scan turned up no other missed phrasing,
// and words like "virtual" or "flexible" are not here because they produce
// false positives ("Virtual Reality Engineer") without evidence of a real miss.
const REMOTE_RE = /\b(remote|distributed|work from home|wfh|anywhere|home[- ]based)\b/i;
